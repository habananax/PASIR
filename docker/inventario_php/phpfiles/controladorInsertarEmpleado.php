<html>
  <head>
    <title>Proceso de inserci&oacute;n de empleados</title>
    <link rel="stylesheet" href="./style.css">
  </head>
  <body>
    <h3>Guardando datos de un nuevo empleado...</h3>
...
echo $empleadoNuevo->getNombre()."<br>";


//Vamos a por la
$SQLInsert = $empleadoNuevo->getInsertSQL();

...
<head>
  ...
  <body>
    <h2>ACTUALIZAR DATOS EMPLEADOS</h2>
    <h3>Introduce los datos de un empleado que desea actualizar</h3>
    <form action="./controladorActualizarEmpleado.php" method="post">
